import type { User_badges } from "../types/user-badges";

// Typalias för råa JSON-objekt från backend (okända fält och format)
type Rawuser_badge = Record<string, any>;
...
/* ========================================================================== 
   ...
   ========================================================================== */
function normalizeBadge(b: RawUser_badge): User_badge {
...
/* ========================================================================== 
   ...
   ========================================================================== */
export async function getUser_badges(): Promise<Badge[]> {
